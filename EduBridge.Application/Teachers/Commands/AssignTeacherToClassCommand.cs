...
public sealed record AssignTeacherToClassCommand(Guid TeacherId, Guid ClassId)
    : IRequest<Teacher?>;

public sealed class AssignTeacherToClassCommandHandler
    : IRequestHandler<AssignTeacherToClassCommand, Teacher?>
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        teacher.AssignToClass(request.ClassId);
